...
**M0 is complete and M1 is half done.**
...
M1 part 2 is next: the per-minute scheduler, the inline push sink, the load harness, and the first numbers in the table below.
